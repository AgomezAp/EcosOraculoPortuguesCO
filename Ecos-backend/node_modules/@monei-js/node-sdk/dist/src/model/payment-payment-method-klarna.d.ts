...
export declare const PaymentPaymentMethodKlarnaBillingCategoryEnum: {
    readonly PAY_LATER: "PAY_LATER";
    readonly PAY_NOW: "PAY_NOW";
    readonly SLICE_IT: "SLICE_IT";
    readonly SLICE_IT_BY_CARD: "SLICE_IT_BY_CARD";
};
...
export declare const PaymentPaymentMethodKlarnaAuthPaymentMethodEnum: {
    readonly INVOICE: "invoice";
    readonly FIXED_AMOUNT: "fixed_amount";
    readonly PIX: "pix";
    readonly BASE_ACCOUNT: "base_account";
    readonly DEFERRED_INTEREST: "deferred_interest";
    readonly DIRECT_DEBIT: "direct_debit";
    readonly DIRECT_BANK_TRANSFER: "direct_bank_transfer";
    readonly B2B_INVOICE: "b2b_invoice";
    readonly CARD: "card";
    readonly SLICE_IT_BY_CARD: "slice_it_by_card";
};
