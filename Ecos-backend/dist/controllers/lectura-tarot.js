...
Resposta do guia espiritual (certifique-se de completar TODA sua guia antes de terminar):`;
                ...
                console.log(`✅ Leitura de animal interior gerada com sucesso com ${usedModel} (${text.length} caracteres)`);
            ...
            try {
                res.json({
                    ...
                    guide: {
                        ...
                        description: "Xamã ancestral especializada em conectar almas com seus animais guia totêmicos",
                    },
                    timestamp: new Date().toISOString(),
                });
            }
