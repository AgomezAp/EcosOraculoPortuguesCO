  ...
  implements OnInit, OnDestroy, AfterViewChecked, AfterViewInit
{
  ...
  private guideData: AnimalGuideData = {
    name: 'Xamã Olivia',
    specialty: 'Guia dos Animais Internos',
  ...
  animalPrizes: Prize[] = [
    {
      id: '1',
      name: '3 Giros da Roda Animal',
      color: '#4ecdc4',
      icon: '🦉',
    },
    { id: '2', name: '1 Guia Animal Premium', color: '#45b7d1', icon: '🦋' },
    {
      id: '4',
  ...
  private initializeWelcomeMessage(): void {
    this.addMessage({
      sender: 'Xamã Olivia',
      content: `🦉 Olá, Buscador! Sou Olivia, sua guia espiritual do reino animal. Estou aqui para ajudá-lo a descobrir seu animal interno e se conectar com ele.
...
O que você gostaria de explorar sobre seu espírito animal?`,
  ...
  onPrizeWon(prize: Prize): void {
    const prizeMessage: ChatMessage = {
      sender: 'Xamã Olivia',
      content: `🦉 Os espíritos animais falaram! Você ganhou: **${prize.name}** ${prize.icon}\n\nOs antigos guardiões do reino animal decidiram abençoá-lo com este presente sagrado. A energia espiritual flui através de você, conectando-o mais profundamente com seu animal interno. Que a sabedoria antiga o guie!`,
      timestamp: new Date(),
      isUser: false,
    };
    ...
    switch (prize.id) {
      ...
      case '2': // 1 Guía Premium - ACCESO COMPLETO
        ...
        const premiumMessage: ChatMessage = {
          sender: 'Xamã Olivia',
          content:
            '🦋 **Você desbloqueou o acesso Premium completo!** 🦋\n\nOs espíritos animais sorriram para você de uma forma extraordinária. Agora você tem acesso ilimitado a toda a sabedoria do reino animal. Você pode consultar sobre seu animal interno, conexões espirituais e todos os mistérios antigos quantas vezes quiser.\n\n✨ *Os guardiões do reino animal abriram todas as suas portas para você* ✨',
          timestamp: new Date(),
          isUser: false,
        };
